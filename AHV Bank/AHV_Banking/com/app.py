import sys
sys.path.append('/Users/harshavardhan/Downloads/AHV Bank/AHV_Banking/')


from AHV_Banking.com.service.user_service import *
from AHV_Banking.com.service.banner_printing import *
from AHV_Banking.com.service.banking_service import *
import time
...
while True:
    ...
    if userChoice == 1:
        ...
        print()
        print("[+] Thank You for using AHV Bank, See you soon..")
        quit()
